      ...
      <div class="messages-container" ref="messagesRef">
        <div v-if="messages.length === 0" class="welcome-screen">
          ...
          <div class="feature-list">
            <div class="feature-item" @click="setQuickPrompt('请帮我总结这篇文档的核心内容')" style="cursor: pointer;">
              <el-icon><Document /></el-icon>
              <span>文档解析</span>
            </div>
            <div class="feature-item" @click="setQuickPrompt('文档中关于XXX的描述是什么？')" style="cursor: pointer;">
              <el-icon><Search /></el-icon>
              <span>精准检索</span>
            </div>
            <div class="feature-item" @click="setQuickPrompt('基于提供的上下文，回答以下问题：')" style="cursor: pointer;">
...
const API_BASE = import.meta.env.VITE_API_BASE || '/api/vector'
